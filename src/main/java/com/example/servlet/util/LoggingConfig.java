...
/**
 * Utility class to configure logging properties from application.yml This must be called before any
 * logger is initialized
 */
public class LoggingConfig {

  /**
   * Initialize logging configuration from application.yml Sets system properties that logback.xml
   * can reference
   */
  ...
  /**
   * Set a system property only if it's not already set This allows environment variables to
